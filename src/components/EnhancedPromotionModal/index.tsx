      ...
      <Dialog as="div" className="relative z-50" onClose={noop}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="dark:via-gray-850 relative w-full max-w-xl transform overflow-hidden rounded-2xl border border-blue-200 bg-gradient-to-br from-white via-blue-50 to-indigo-100 p-0 text-left shadow-2xl transition-all dark:border-gray-700 dark:from-gray-800 dark:to-gray-900 sm:my-8">
                ...
                {/* Content */}
                <div className="px-5 pb-6 pt-10 sm:px-8 sm:pb-8">
                  {/* Icon and title */}
                  ...
                  <div className="space-y-4 py-2 text-sm text-gray-700 dark:text-gray-300">
                    <p className="text-center font-medium text-gray-900 dark:text-white">
                      Not a programmer? Want your own custom study dictionary? Simple to use — upload with one click and start right away.
                      <br />
                      <div className="my-2"></div>
                      We recommend QwertyLearner.ai, built and operated by the UK DeepLearningAI team.
                    </p>

                    <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800">
                      <h4 className="mb-3 font-semibold text-gray-900 dark:text-white">🚀 Pro features</h4>
                      <ul className="space-y-2.5">
                        <li className="flex items-start">
                          <span className="mr-2 mt-0.5 text-blue-500">•</span>
                          <span>
                            <strong>AI smart dictionaries</strong> — one-click upload with auto-generated definitions and parts of speech
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="mr-2 mt-0.5 text-blue-500">•</span>
                          <span>
                            <strong>Article practice</strong> — custom article content for real-world practice
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="mr-2 mt-0.5 text-blue-500">•</span>
                          <span>
                            <strong>Cloud sync</strong> — practice records and error books synced across devices
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="mr-2 mt-0.5 text-blue-500">•</span>
                    ...
                    <div className="rounded-lg bg-amber-50 p-3 text-xs text-amber-800 dark:bg-amber-900/20 dark:text-amber-200">
                      <p>
                        <strong>Note:</strong> QwertyLearner.ai is independently developed and operated by DeepLearningAI (UK). It is a
                        separate derivative of the open-source QwertyLearner, which will remain open source and openly operated.
                      </p>
                    </div>
                  </div>
