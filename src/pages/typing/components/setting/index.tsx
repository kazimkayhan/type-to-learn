...
export default function Setting() {
  ...
  return (
    <Dialog onOpenChange={setIsOpen} open={isOpen}>
      ...
      <DialogContent
        className="flex w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-white p-0 shadow-xl sm:max-w-3xl dark:bg-gray-800"
        showCloseButton={true}
      >
        <div className="relative flex h-16 items-end justify-between rounded-t-lg border-neutral-100 border-b bg-stone-50 px-4 py-3 sm:h-20 sm:px-6 dark:border-neutral-700 dark:bg-gray-900">
          <DialogTitle className="font-bold text-gray-700 text-xl sm:text-2xl dark:text-gray-200">
            Settings
          </DialogTitle>
        </div>
        ...
        <Tabs
          ...
          defaultValue="sound"
        >
          <TabsList className="flex w-full flex-row items-stretch space-x-1 overflow-x-auto border-neutral-100 border-b bg-stone-50 px-2 py-2 md:h-full md:w-48 md:flex-col md:items-start md:space-x-0 md:space-y-2 md:overflow-visible md:border-r md:border-b-0 md:px-4 md:py-3 dark:border-transparent dark:bg-gray-900">
            <TabsTrigger
              className="flex h-10 flex-shrink-0 items-center justify-start gap-2 rounded-md px-3 font-bold text-gray-600 text-sm hover:bg-white data-[state=active]:bg-indigo-400 data-[state=active]:text-white md:w-full md:justify-start dark:text-gray-300 dark:hover:bg-gray-800"
              value="sound"
            >
