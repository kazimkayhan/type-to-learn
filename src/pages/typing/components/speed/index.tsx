...
export default function Speed() {
  ...
  return (
    <div className="my-card flex w-full max-w-full flex-wrap justify-center gap-2 rounded-xl bg-card px-2 py-2 opacity-50 transition-colors duration-300 sm:max-w-3xl sm:flex-nowrap sm:gap-0 sm:px-2 sm:py-4 md:px-4 md:py-10">
