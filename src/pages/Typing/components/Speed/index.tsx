...
export default function Speed() {
  ...
  return (
    <div className="my-card flex w-full max-w-full flex-wrap justify-center gap-2 rounded-xl bg-white px-3 py-3 opacity-50 transition-colors duration-300 dark:bg-gray-800 sm:max-w-3xl sm:flex-nowrap sm:gap-0 sm:px-2 sm:py-4 md:px-4 md:py-10">
