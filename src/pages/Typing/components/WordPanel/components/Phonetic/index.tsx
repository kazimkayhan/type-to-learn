...
function Phonetic({ word }: PhoneticProps) {
  ...
  return (
    <div
      className={`flex flex-wrap items-center justify-center gap-x-5 text-center text-sm font-normal text-gray-600 transition-colors duration-300 dark:text-gray-400 ${
